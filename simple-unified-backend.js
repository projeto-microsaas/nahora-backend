...
// Middleware CORS - Permitir todas as origens para desenvolvimento
app.use(cors({
...
app.get('/api/health', (req, res) => {
  res.json({ 
    ...
    jwt_secret_available: JWT_SECRET ? 'YES' : 'NO'
  });
});
...
server.listen(PORT, '0.0.0.0', () => {
  console.log(`🚀 Servidor unificado SIMPLES rodando na porta ${PORT}`);
